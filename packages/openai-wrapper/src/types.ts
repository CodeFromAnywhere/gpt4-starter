...
export const openAiChatModelsReadonly = [
  "gpt-3.5-turbo",
  // I think there's no difference. This is the march 1st release (2023). The above one will probably be updated to newer versions, while this one will pinpoint to this specific release.
  "gpt-3.5-turbo-0301",
] as const;

export const openAiChatModels: string[] = [...openAiChatModelsReadonly];
