...
var test = function () { return __awaiter(void 0, void 0, void 0, function () {
    var projectRoot, basePath, paths;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                if (!projectRoot)
                    return [2 /*return*/];
                basePath = ["knowledge", "operations", "assets"].map(function (x) {
                    return path_1.default.join(projectRoot, x);
                });
            ...
            case 1:
                ...
                paths.map(function (p) { return fs_util_1.fs.rm(p); });
...
test();
//# sourceMappingURL=removeOldTranscriptions.test.js.map