...
export declare const sdk: {
    ...
    AssetInput: (props: {
        immediateUpload?: boolean | undefined;
        ...
        onChangeLoading?: ((isLoading: boolean) => void) | undefined;
    ...
    AssetView: (props: {
        transcription?: import("ai-types").Transcription | undefined;
    ...
    TranscriptionSentence: (props: {
        time: number;
        sentence: import("ai-types").TranscribedText;
        transcription: import("ai-types").Transcription;
    ...
    useInfiniteGetDbModel: () => import("react-query").UseInfiniteQueryResult<import("api-types").ApiReturnType<"getDbModelWithContext">, unknown>;
    ...
    ContentSearch: () => JSX.Element;
    Explorer: (props: {}) => JSX.Element;
    FolderMenu: () => JSX.Element;
    FoldersPiece: (props: {
    ...
    PathSearch: () => JSX.Element;
    QueueStatusComponent: () => JSX.Element | null;
    RecentPinned: () => JSX.Element;
    SearchResultComponent: (props: {
        searchResult: import("search-types").SearchResult;
        index: number;
    }) => JSX.Element;
    SearchResultPage: () => JSX.Element;
    setConfig: (apiUrl: string, disableAdmin: boolean, customCustomProjectRelativeBasePaths: string[]) => void;
    ...
    AuthenticationLayout: (props: {
        ...
        customMenu?: import("react").ReactNode;
    ...
    useReferencableModelData: (simplifiedSchema: SimplifiedSchema) => import("simplified-schema-form").ReferencableModelData | undefined;
    ...
    FileCollectionActions: () => JSX.Element;
    FileCollectionPage: () => JSX.Element;
    FileSpecificPrompts: (props: {
        ...
        isFolder?: boolean | undefined;
        thePrompts?: import("ai-types").ContextualPrompt[] | undefined;
        markdown?: string | null | undefined;
    }) => JSX.Element;
    FileWriter: (props: {
        projectRelativeFilePath: string;
    }) => JSX.Element;
    getReaderPageInfo: (isFolder: boolean | undefined, contextualPromptsObject: Omit<import("ai-types").ContextualPromptsObject, "databaseContextualPromptSlugs"> | null | undefined, contextualPromptResults: import("ai-types").ContextualPromptResult[] | null | undefined) => {
    ...
    openDownload: (projectRelativePath: string) => Promise<void>;
    PromptButton: (props: {
    ...
    PromptViewer: (props: {
        ...
        contextualPrompts?: import("ai-types").ContextualPrompt[] | undefined;
    }) => JSX.Element;
    ...
    TextFile: (props: {
        item: import("file-collection-util").FileCollectionFile;
        index: number;
    }) => JSX.Element;
    TextWriter: (props: {
    ...
    TranscriptionPlayer: () => JSX.Element;
    useOnFocus: () => void;
    ...
    FrontmatterForm: (props: {
        ...
        frontmatterSchema: import("schema-types").SimplifiedSchema;
