...
exports.firstCoreFunction = void 0;
 ...
 */
var firstCoreFunction = function (port, isWatching, isRestart) { return __awaiter(void 0, void 0, void 0, function () {
    var tsFunctions;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, scheduleCronJobs_1.scheduleCronJobs)(tsFunctions)];
            case 2:
                // only on the first core, schedule crons and initiate watchers
                _a.sent();
                if (isWatching) {
                    (0, watch_all_1.watchAll)(tsFunctions);
                }
                return [2 /*return*/];
        }
    });
}); };
exports.firstCoreFunction = firstCoreFunction;
//# sourceMappingURL=firstCoreFunction.js.map