...
*/
var getReaderPageProps = function (config) { return __awaiter(void 0, void 0, void 0, function () {
    var customAbsoluteBaseFolderPath, projectRelativeBasePaths, queryPath, isAdmin, projectRoot, absoluteBaseFolderPath, contextualPromptCategories, _a, finalAbsoluteFolderPath, finalAbsolutePath, isAllowedHere, isFile, markdownParse, _b, allowedOtherExtensions, pathParse, rawContent, _c, isDev, canSeeContent, fileContentString, augmentedResult, props;
    var _d;
    return __generator(this, function (_e) {
        switch (_e.label) {
            case 0:
                customAbsoluteBaseFolderPath = config.customAbsoluteBaseFolderPath, projectRelativeBasePaths = config.projectRelativeBasePaths, queryPath = config.queryPath, isAdmin = config.isAdmin;
                projectRoot = (0, get_path_1.getProjectRoot)();
                absoluteBaseFolderPath = customAbsoluteBaseFolderPath || projectRoot;
            ...
            case 1:
                ...
                if (!projectRoot ||
                    ...
                    !fs_util_1.fs.existsSync(absoluteBaseFolderPath)) {
                    return [2 /*return*/, {
                            props: {
                                notFound: true,
                ...
                return [4 /*yield*/, (0, getExplorablePathDetails_1.getExplorablePathDetails)(projectRoot, absoluteBaseFolderPath, queryPath, projectRelativeBasePaths, customAbsoluteBaseFolderPath)];
            case 2:
