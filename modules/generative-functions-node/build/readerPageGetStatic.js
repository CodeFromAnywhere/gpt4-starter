...
var getReaderPagePropsWithContext_1 = require("./getReaderPagePropsWithContext");
...
var readerPageGetStaticProps = function (context) { return __awaiter(void 0, void 0, void 0, function () {
    var queryPath, realQueryPathArray, realQueryPath, staticPropResult, _a;
    var _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                // NB: no context!
                return [4 /*yield*/, (0, getReaderPagePropsWithContext_1.getReaderPagePropsWithContext)(undefined, {
                        queryPath: realQueryPath,
                        // can't take into account the custom one from the store, but this one is static
                        customProjectRelativeBaseFolderPath: process.env.NEXT_PUBLIC_BASEPATH,
                    })];
            case 1:
                staticPropResult = _a.apply(void 0, [
                    // NB: no context!
                    _c.sent()]);
...
var readerPageGetStaticPaths = function () { return __awaiter(void 0, void 0, void 0, function () {
    var basePath, projectRoot, realBasePath;
