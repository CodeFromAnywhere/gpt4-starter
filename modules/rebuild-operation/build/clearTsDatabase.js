...
exports.clearTsDatabase = void 0;
 ...
 */
var clearTsDatabase = function (operationName) { return __awaiter(void 0, void 0, void 0, function () {
    var result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, Promise.all(code_types_1.typescriptIndexModels.map(function (modelName) {
                    return database_1.db.clear(modelName, { operationName: operationName });
                }))];
            case 1:
                result = _a.sent();
...
exports.clearTsDatabase = clearTsDatabase;
//# sourceMappingURL=clearTsDatabase.js.map