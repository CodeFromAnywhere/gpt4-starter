 ...
 */
export type IncludeConfig = (Include & {
    /**
     * NOT SUPPORTED YET
     *
...
export type DbGet<TModels> = <TModelName extends Keys<TModels>>(modelName: TModelName, config?: GetQueryConfig<TModels[TModelName]>) => Promise<TModels[TModelName][]>;
export type DbGetByFile<TModels> = <TModelName extends Keys<TModels>>(modelName: TModelName, config?: CustomQueryConfig) => Promise<{
    [absolutePath: string]: TModels[TModelName][];
}>;
export type DbRemove<TModels extends AnyModelObject> = <TModelName extends Keys<TModels>>(modelName: TModelName, where: (content: TModels[TModelName]) => boolean, config?: CustomQueryConfig) => Promise<DbQueryResult>;
export type DbUpdate<TModels extends AnyModelObject> = <TModelName extends Keys<TModels>>(modelName: TModelName, updateWhere: undefined | ((content: TModels[TModelName]) => boolean), map: (content: TModels[TModelName]) => TModels[TModelName], config?: CustomQueryConfig) => Promise<DbQueryResult>;
export type DbSet<TModels extends AnyModelObject, TModelKey extends Keys<TModels> = Keys<TModels>> = <TModelName extends TModelKey>(modelName: TModelName, data: Creation<TModels[TModelName]>[], config?: CustomQueryConfig) => Promise<DbQueryResult>;
export type DbUpsert<TModels extends AnyModelObject, TModelKey extends Keys<TModels> = Keys<TModels>> = <TModelName extends TModelKey>(
...
export type DbClear<TModels extends AnyModelObject> = <TModelName extends Keys<TModels>>(modelName: TModelName, config?: CustomQueryConfig) => Promise<DbQueryResult>;
/**
