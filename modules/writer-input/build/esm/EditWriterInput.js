...
export var EditWriterInput = function (props) {
    var onChange = props.onChange, value = props.value, projectRelativeFilePath = props.projectRelativeFilePath, markdownModelName = props.markdownModelName, projectRelativeFolderPath = props.projectRelativeFolderPath;
                                ...
                                switch (_b.label) {
                                    case 0:
                                        if (newBackendAssets.length === 0)
                                            return [2 /*return*/];
                                        return [4 /*yield*/, api.processAssetUploadWithContext(projectRelativeFolderPath, newBackendAssets)];
                                    case 1:
                                        apiResult = _b.sent();
                                        ...
                                        assetsMarkdownString = (_a = apiResult.result.processed) === null || _a === void 0 ? void 0 : _a.map(function (backendAsset) {
