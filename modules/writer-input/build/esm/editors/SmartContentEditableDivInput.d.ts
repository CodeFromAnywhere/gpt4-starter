...
export type ParseTextContentToHtmlString = (textContent: string, type: "typescript" | "markdown" | "json", subtextConfig: SubtextConfig, subwordConfig: SubwordConfig, markdownParseRenderConfig?: MarkdownParseRenderConfig) => string;
/**
