...
var FunctionForm = function (props) {
    var _a;
    var initialValues = props.initialValues, modelName = props.modelName, projectRelativeStorageFilePath = props.projectRelativeStorageFilePath, tsFunction = props.tsFunction, submitFunction = props.submitFunction, withResult = props.withResult, withApiResult = props.withApiResult, showResult = props.showResult, referencableModelData = props.referencableModelData;
    ...
    return ((0, jsx_runtime_1.jsx)(react_with_native_1.Div, { children: (0, jsx_runtime_1.jsxs)(simplified_schema_form_1.FormContainer, __assign({ isLoading: isLoading, onSubmit: function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        setValues(values);
                    }, values: values, referencableModelData: referencableModelData })] })) }));
};
