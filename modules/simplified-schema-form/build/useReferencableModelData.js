...
/**
     ...
     */
var r=a.map((function(e){var t,a=e,r=api_1.queries.useGetReferencableModelDataWithContext(a),i=r.data,l=r.isLoading,u=null==i?void 0:i.result;return(t={})[e]={data:u,isLoading:l},t})).filter(js_util_1.notEmpty);return r?(0,js_util_1.mergeObjectsArray)(r):void 0}};exports.useReferencableModelData=useReferencableModelData;
