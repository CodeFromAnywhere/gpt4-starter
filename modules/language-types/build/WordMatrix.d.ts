...
type LanguageAudio = BackendAsset;
type LanguageExample = {
    text: string;
    audio: BackendAsset;
};
type LanguageLatin = string;
type LanguageAlternative = string;
type LanguagePhonetic = string;
/**
 ...
 * @see Language
 */
export type WordMatrix = WordLanguageInfoObject & WordInfo & CoreWordMatrixWord & SlugModelType;
/**
