...
var r=a.pop(),t=r.substring(-1),s=t.toUpperCase()!==t,n=e.toLowerCase()!==e,i=s&&n?[r,e]:["".concat(r).concat(e)];
//let's also get the last letter
return a.concat(i)}),[""]);
// if it was lowercase but it became upper, it's a new word
},nonCasingDelimiters=/[\s,._-]+/,getDelimiter=function(a){return"capital"===a?"_":"human"===a?" ":"kebab"===a?"-":"snake"===a?"_":""};
/**
 * Besides normal delimiters, every capital letter also marks the start of a new word
 */exports.getDelimiter=getDelimiter;var capitaliseFirstLetter=function(a){return a.charAt(0).toUpperCase().concat(a.substring(1))};exports.capitaliseFirstLetter=capitaliseFirstLetter;var convertToTargetCasing=function(a,e,r){return"capital"===r?a.toUpperCase():"kebab"===r||"snake"===r?a.toLowerCase():"pascal"===r?(0,exports.capitaliseFirstLetter)(a):"camel"===r?0===e?a.toLowerCase():(0,exports.capitaliseFirstLetter)(a):0===e?(0,exports.capitaliseFirstLetter)(a):a.toLowerCase()},convertCase=function(
/**
