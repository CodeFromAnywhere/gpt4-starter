...
var markdownindex_json_1 = __importDefault(require("markdown-types/db/ts-interfaces/markdownindex.json"));
/**
    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 4:
                ...
                parsedParameters = (0, frontmatter_util_1.frontmatterToObject)(mdParse.parameters, markdownindex_json_1.default.type.simplifiedSchema);
                ...
                parsedParameters.markdownCallToActions =
                    ((_b = parsedParameters.markdownCallToActionSlugs) === null || _b === void 0 ? void 0 : _b.map(function (slug) {
                        return markdownCallToActions.find(function (x) { return x.slug === slug; });
                    }).filter(js_util_1.notEmpty)) || [];
                parsedParameters.header_markdownCallToActions =
                    ((_c = parsedParameters.header_markdownCallToActionSlugs) === null || _c === void 0 ? void 0 : _c.map(function (slug) {
                        return markdownCallToActions.find(function (x) { return x.slug === slug; });
                    }).filter(js_util_1.notEmpty)) || [];
