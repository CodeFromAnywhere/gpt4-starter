...
var ModelComponent = function (props) {
    ...
    var metadataQuery = api_1.queries.useGetDbModelMetadataWithContext(modelName);
    ...
    var modelReferences = api_1.queries.useGetReferencableModelDataWithContext(modelName);
        ...
        alert === null || alert === void 0 ? void 0 : alert("Are you sure?", "Do you want to delete this one?", [
            {
                ...
                onPress: function () {
                    if (item === null || item === void 0 ? void 0 : item.id) {
                        ...
                        api_1.api
                            .deleteDbModelWithContext(modelName, item.id)
    ...
    var updateItem = function (item) {
        return router.push("/db/upsert/".concat(modelName, "?id=").concat(item === null || item === void 0 ? void 0 : item.id));
    };
    var updateAction = {
        name: "Update",
        emoji: "✏️",
