...
var UpsertForm = function (props) {
    ...
    var metadataQuery = api_1.queries.useGetDbModelMetadataWithContext(modelFromUrl);
    ...
    var getReferencableModelDataQuery = api_1.queries.useGetReferencableModelDataWithContext(modelFromUrl);
    ...
    var onSubmitForm = function () {
        ...
        setLoading(true);
        api_1.api
            .upsertDbModelWithContext(modelFromUrl, body)
