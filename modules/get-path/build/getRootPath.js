 ...
 */
exports.osRootFoldersConst=["assets","backups","bundled","cloned","distributions","operations","knowledge"],
/**
...
if(exports.projectRootFolders.concat(exports.osRootFolders).includes(o))return"knowledge"===o?fs_util_1.path.resolve(t,"knowledge"):fs_util_1.path.resolve(t,o);console.log("getRootPath: Should never happen, probably a wrong input was provided:",{name:o})}};exports.getRootPath=getRootPath;
