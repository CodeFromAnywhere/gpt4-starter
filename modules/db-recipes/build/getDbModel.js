...
exports.getDbModelWithContext = void 0;
...
var getDbModelWithContext = function (functionContext, 
/**
...
search) { return __awaiter(void 0, void 0, void 0, function () {
    var canRead, data, slicedStartData, slicedLimitData, hasMore, filteredData, sortedData, searchedData, subsetData, ignoredData, finalData;
    var _a, _b, _c;
        ...
        switch (_d.label) {
            ...
            case 1:
                ...
                if (!canRead) {
                    return [2 /*return*/, {
                            isSuccessful: false,
                            message: "You're not allowed to read this model",
                            data: [],
                            hasMore: false,
                        }];
                }
...
exports.getDbModelWithContext = getDbModelWithContext;
