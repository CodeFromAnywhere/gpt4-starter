...
export type DatasetConfigShape = {
 ...
 */
export type DatasetItem<TItem extends AugmentedAnyModelType, TDataset extends DatasetConfig> = TDataset["objectParameterKeys"] extends undefined ? TDataset["ignoreObjectParameterKeys"] extends undefined ? TItem : Partial<TItem> : Partial<TItem>;
