...
export type IsWithContextFunction<TFunctionName extends string> = StringEndsWith<TFunctionName, typeof contextFunctionConventionSuffix>;
export type IsWithContextRawFunction<TFunctionName extends string> = StringEndsWith<TFunctionName, typeof rawFunctionConventionSuffix>;
export type IsGetApiFunction<TFunctionName extends string> = StringEndsWith<TFunctionName, typeof getFunctionConventionSuffix>;
/**
 * based on the function name, the api result should be raw without the wrapped `ApiReturnType` object
 */
export type IsRawApiResultFunction<TFunctionName extends string> = IsWithContextRawFunction<TFunctionName> extends true ? true : IsGetApiFunction<TFunctionName> extends true ? true : false;
/**
 * Function is a regular function without any `api` altering conventions
 */
export type IsRegularFunction<TFunctionName extends string> = IsWithContextFunction<TFunctionName> extends true ? false : IsGetApiFunction<TFunctionName> extends true ? false : IsWithContextRawFunction<TFunctionName> extends true ? false : true;
