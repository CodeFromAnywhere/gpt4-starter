...
export type ExecuteFunctionResult = {
    ...
    isCached?: boolean;
    /**
     * If true, the user doesn't have enough `credit` balance to pay for execution of this function according to expected cost.
     */
...
export type FnReturn<Fn extends keyof SdkType> = WithoutPromise<ReturnType<SdkType[Fn]>>;
/**
 ...
 */
export type RealApiReturnType<TFunctionName extends keyof SdkType> = IsRawApiResultFunction<TFunctionName> extends true ? FnReturn<TFunctionName> : ApiReturnType<TFunctionName>;
/**
 * API SDK type
 */
 ...
 */
export type ParametersWithoutContext<TFunctionName extends keyof SdkType> = IsRegularFunction<TFunctionName> extends true ? Parameters<SdkType[TFunctionName]> : Shift<Parameters<SdkType[TFunctionName]>>;
export type ApiTypeWithConfig = {
...
export type ApiTypeWithoutConfig = {
