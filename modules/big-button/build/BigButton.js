...
var BigButton = function (button) {
    ...
    return ((0, jsx_runtime_1.jsx)(react_with_native_1.Div, __assign({ className: "cursor-pointer ".concat(colors, " p-3 rounded-md border-2 border-black"), onClick: function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        setIsLoading(true);
                        return [4 /*yield*/, button.onClick()];
                    case 1:
                        _a.sent();
                        setIsLoading(false);
                        return [2 /*return*/];
