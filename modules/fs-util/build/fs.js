...
var rename=(0,util_1.promisify)(graceful_fs_1.default.rename),mkdir=(0,util_1.promisify)(graceful_fs_1.default.mkdir),readFile=(0,util_1.promisify)(graceful_fs_1.default.readFile),writeFile=(0,util_1.promisify)(graceful_fs_1.default.writeFile),access=(0,util_1.promisify)(graceful_fs_1.default.access),watch=(0,util_1.promisify)(graceful_fs_1.default.watch),appendFile=(0,util_1.promisify)(graceful_fs_1.default.appendFile),chmod=(0,util_1.promisify)(graceful_fs_1.default.chmod),chown=(0,util_1.promisify)(graceful_fs_1.default.chown),copyFile=(0,util_1.promisify)(graceful_fs_1.default.copyFile),cp=(0,util_1.promisify)(graceful_fs_1.default.cp),rm=(0,util_1.promisify)(graceful_fs_1.default.rm),readdir=(0,util_1.promisify)(graceful_fs_1.default.readdir),realpath=(0,util_1.promisify)(graceful_fs_1.default.realpath),stat=(0,util_1.promisify)(graceful_fs_1.default.stat),readFileSync=graceful_fs_1.default.readFileSync,readdirSync=graceful_fs_1.default.readdirSync,writeFileSync=graceful_fs_1.default.writeFileSync,createReadStream=graceful_fs_1.default.createReadStream,gracefulFsSync={readFileSync:readFileSync,readdirSync:readdirSync,writeFileSync:writeFileSync,createReadStream:createReadStream},gracefulFsPromises={
// sync, should be discouraged
rmSync:graceful_fs_1.rmSync,existsSync:graceful_fs_1.existsSync,accessSync:graceful_fs_1.accessSync,cpSync:graceful_fs_1.cpSync,
// promisified stuff
 ...
 */
exports.fs=__assign(__assign(__assign(__assign({},gracefulFsPromises),gracefulFsConstants),fsPromises),gracefulFsSync);
