    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                newPerson = __assign({ id: newPersonId, authenticationMethods: device.authenticationMethods.map(
            ...
            case 2:
                ...
                return [4 /*yield*/, database_1.db.update("Device", function (item) { return item.id === device.id; }, function (old) {
                        console.log("set new person id to ".concat(newPersonId, ", remove authenticationMethods"));
                        return __assign(__assign({}, old), { authenticationMethods: [], personIds: old.personIds
